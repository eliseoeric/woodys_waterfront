...
<section id="" <?php post_class('wrapper'); ?>>
	<div class="row wrapper full_width double reviews__main_content hero-image" style="background-image: url('<?php echo wp_get_attachment_url( get_post_thumbnail_id( $post_id )); ?>');">
		<div class="seven columns entry-content">
