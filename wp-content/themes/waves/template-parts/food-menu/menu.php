<section class="wrapper waves-section menu-tabs" data-top="0 .5 .5 0 .75 0 1 .2" data-bottom="0 .2 .5 0 .5 .6 1 .6" data-background="image http://localhost/woodys_waterfront/wp-content/uploads/2016/03/entrace_1_bg.png">
	<?php //get the menus ?>
	...
	<div class="container">
		<ul class="accordion-tabs">
			...
			<li class="tab-header-and-content">
				<a href="javascript:void(0)" class="tab-link "><?= get_the_title(); ?></a>
